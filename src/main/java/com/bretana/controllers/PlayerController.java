...
public class PlayerController {
    ...
    public ResponseEntity<Collection<Player>> getPlayersByCountry(@RequestParam(value="country") String country) {
        return new ResponseEntity<>(repository.findByCountry(country), HttpStatus.OK);
    }
